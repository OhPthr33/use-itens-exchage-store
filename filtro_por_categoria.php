...
// Verifica se o parâmetro 'categoria_id' está definido na URL
$categoria_id = $_GET['categoria_id'] ?? null;

// Verifica se o ID da categoria é válido
if ($categoria_id !== null && is_numeric($categoria_id)) {
    // Consulta para obter produtos com base na categoria
    $stmt = $conn->prepare("SELECT * FROM items WHERE id_categ = ?");
